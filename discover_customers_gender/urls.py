"""discover_customers_gender URL Configuration
...
from discover_customers_gender import settings
...
urlpatterns = [
    ...
    url(r'^Predict_Customer_Gender_Type/$', remoteuser.Predict_Customer_Gender_Type, name="Predict_Customer_Gender_Type"),
    ...
    url(r'^View_Customers_Gender_Type_Ratio/$', serviceprovider.View_Customers_Gender_Type_Ratio, name="View_Customers_Gender_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_Customers_Gener_Type/$', serviceprovider.View_Prediction_Of_Customers_Gener_Type, name="View_Prediction_Of_Customers_Gener_Type"),
